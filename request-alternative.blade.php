  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Request alternative medicine</h2>
          </div>
          <div class="col-md-12">
    
          <form action="{{route('demand.alternative')}}" method="get" class="bg-light p-5 contact-form" enctype="multipart/form-data">
            @csrf
