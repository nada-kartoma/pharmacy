  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row  mb-5">
          <div class="col-md-12">
            <h2 class="h3 mb-5 text-black">Drug Alternatives</h2>
          </div>
          <div class="col-md-12 site-blocks-table">

              <!-- عرض الجدول إذا كانت هناك بيانات -->
                      ...
                      <tbody>
                          @foreach ($alternatives as $alternative)
                              <tr>
                                  ...
                                  <td>{{ $alternative['active_ingredients'] }}</td>
              ...
              @else
                  <p>No alternatives found for the given drug name.</p>
              @endif
